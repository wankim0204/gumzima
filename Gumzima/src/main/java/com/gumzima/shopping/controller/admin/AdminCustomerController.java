...
public class AdminCustomerController {
	...
	// 전체목록
	@RequestMapping(value = "/admin/customer/customer_list", method = RequestMethod.GET)
	...
	// 1건 문의 상세보기
	@RequestMapping(value = "/admin/customer/customerdetail", method = RequestMethod.GET)
	...
	// 1건 문의 답변보내기
	@ResponseBody
	@RequestMapping(value = "/admin/customer/customerupdate", method = RequestMethod.POST, produces = "text/html;charset=utf-8")
